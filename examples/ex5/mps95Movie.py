...
if "pressure" in inputJson["simulation"]:
    defaultCameraPosition = [0.22692842270753635, -0.3802850955266547, -0.4233385842482629]
    defaultCameraFocalPoint = [4.797540764278407e-18, -0.3595555000000002, -0.027543499999999995]
    defaultCameraViewUp = [-0.02694566148565632, -0.998956698093862, 0.03687067480409438]
else
    defaultCameraPosition = [1.2007737695527859, -0.16394057453798055, -0.5569876615568349]
