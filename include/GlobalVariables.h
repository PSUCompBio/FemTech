...
/* Currently HGO Isotropic model uses 5 properties + 13 properties for
 * viscoelastic properties*/
static int MAXMATPARAMS = 18; /* maximum number of material parameters stored for each element */
