      ...
      //printf("mat ID %d\n", materialID[elementID]);
			...
			if(materialID[elementID]==1){ //CompressibleNeoHookean
				...
				fscanf(File,"%lf %lf %lf",&properties[index+0],
															 &properties[index+1],
															 &properties[index+2]);
				printf("element %d Compressible NeoHookean properties (rho, mu, lambda) = %3.3f %3.3f %3.3f\n",
					elementID,properties[index+0],properties[index+1],properties[index+2]);
				...
				fscanf(File,"%lf %lf %lf",&properties[index+0],
															 &properties[index+1],
															 &properties[index+2]);
				printf("element %d St. Venant-Kirchhoff properties (rho, mu, lambda) = %3.3f %3.3f %3.3f\n",
					elementID,properties[index+0],properties[index+1],properties[index+2]);
